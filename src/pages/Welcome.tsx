        ...
        {step === 'welcome' && (
          ...
          >
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl p-12 text-center border border-slate-700/50">
              ...
              >
                  <div className="w-28 h-28 bg-gradient-to-br from-purple-500 via-blue-400 to-blue-500 rounded-2xl flex items-center justify-center shadow-2xl shadow-purple-500/50 p-2">
                    <img
              ...
              >
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-purple-500 via-pink-400 to-rose-400 text-slate-900 font-semibold py-4 px-8 rounded-xl hover:shadow-2xl transition-all duration-300 text-lg"
                >
                  Get Started
                </motion.button>
          ...
          >
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl p-12 border border-slate-700/50">
              ...
              >
                ...
                >
                  <div className="w-28 h-28 bg-gradient-to-br from-emerald-400 via-green-400 to-teal-400 rounded-2xl flex items-center justify-center shadow-2xl shadow-emerald-500/50 p-2">
                    <img
                      src="https://cdn.builder.io/api/v1/image/assets%2F4b59de728c4149beae05f37141fcdb10%2Ff76700758c784ae1b7f01d6405d61f53?format=webp&width=800"
                      alt="CatShare Logo"
                      className="w-20 h-20 object-contain"
