...
const getGlassThemeWatermarkPosition = (position) => {
  ...
  const glassPositionMap = {
    ...
    "middle-center": { top: "50%", left: "50%", transform: "translate(-50%, -50%)" },
    "middle-right": { top: "50%", right: 10, left: "auto", transform: "translateY(-50%)" },
    // Bottom positions use negative bottom to place below image container (above glass box)
    "bottom-left": { bottom: -25, left: 10, transform: "none" },
    "bottom-center": { bottom: -25, left: "50%", transform: "translateX(-50%)" },
    "bottom-right": { bottom: -25, right: 10, left: "auto", transform: "none" }
  };
