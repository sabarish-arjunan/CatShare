    ...
    <div className="px-4 max-w-lg mx-auto text-sm" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 5px)' }}>
      ...
      <div className="mb-3">
        <button
          ...
          className="bg-blue-400 hover:bg-slate-200 text-slate-800 font-semibold px-6 py-3 rounded-xl shadow-[5px_5px_10px_rgba(0,0,0,0.1),-5px_-5px_10px_rgba(255,255,255,0.9)] hover:shadow-[inset_5px_5px_10px_rgba(0,0,0,0.1)] transition-all duration-300"
        >
          Choose Image
        </button>
