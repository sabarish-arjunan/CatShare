        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <button
                onClick={() => {
                  if (setShowInfo) setShowInfo(true);
                  onClose();
                }}
                className="px-4 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition font-medium flex items-center justify-center gap-2"
              >
