...
export default function CatalogueApp({ products, setProducts, deletedProducts, setDeletedProducts, darkMode, setDarkMode }: { products: any[]; setProducts: (products: any[]) => void; deletedProducts: any[]; setDeletedProducts: (products: any[]) => void; darkMode: boolean; setDarkMode: (value: boolean) => void }) {
